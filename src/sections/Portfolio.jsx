            ...
            <div className='inner-box' id='portfolio'>
                <div className='content'>
                    ...
                    <div className='portfolio-section'>
                        <a href='https://illustrious-biscochitos-cdd8ac.netlify.app/auth' target='_blank' rel='noreferrer'>
                            <div className='portfolio-row'>
                                <div>
                                    <img width='100%' height='100%' src={take_note} alt='Note Taking App'/>
                                </div>
                                <div className='description'>
                                    A basic note taking app, with login and register with Firebase db.
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div className='portfolio-section'>
                        <a href='https://distractionfree.netlify.app/' target='_blank' rel='noreferrer'>
                            <div className='portfolio-row'>
                                <div>
                                    <img width='100%' height='100%' src={distraction_free}
                                         alt='Distraction Free Learning'/>
                                </div>
                                <div className='description'>
                    ...
                    <div className='portfolio-section'>
                        <a href='https://data-frog.netlify.app/numpy/1_create_array/' target='_blank' rel='noreferrer'>
                            <div className='portfolio-row'>
                                ...
                                <div className='description'>
                                    A website for writing about learning about data science. I write the info based on
                                    my learning.
                                </div>
                            </div>
                        </a>
                    ...
                    <div className='portfolio-section'>
                        <a href='https://adventure-dog.netlify.app/' target='_blank' rel='noreferrer'>
                            <div className='portfolio-row'>
                                ...
                                <div className='description'>
                                    A website for articles about taking care of dogs. I'm an avid dog fan, so this is
                                    just for fun.
                                    I used a small blogging technology that allows blog articles to be written in mark
                                    down.
                                </div>
                            </div>
                        </a>
